  ...
  return (
    <div>
      <div className={LandingCSS.siteHeader}>
        <div className={LandingCSS.tabRowContainer}>
          <div className={LandingCSS.tabRow}>
            <div className={LandingCSS.tabLogin}>
              <Link to="/landing" className={LandingCSS.tabLink}>
                {' '}
                Home{' '}
              </Link>
            </div>
            <div className={LandingCSS.tabLogin}>
              <Link to="/demos" className={LandingCSS.tabLink}>
                {' '}
                Demos{' '}
              </Link>
            </div>
            <div className={LandingCSS.tabLogin}>
              <Link to="/ourteam" className={LandingCSS.tabLink}>
                {' '}
                Our Team{' '}
              </Link>
            </div>
            <div className={LandingCSS.tabLogin}>
              <Link to="/research" className={LandingCSS.tabLink}>
                {' '}
                Research{' '}
              </Link>
            </div>
            ...
            <div className={LandingCSS.tabLogin}>
              <Link to="/register" className={LandingCSS.tabLink}>
                {' '}
                Login Register{' '}
              </Link>
            </div>
          ...
          <div className={LandingCSS.dropdown}>
            <input
              type="checkbox"
              id="dropdown-toggle"
              className={LandingCSS.dropdownToggle}
            ></input>
            <label className={LandingCSS.dropbtn} htmlFor="dropdown-toggle">
              Menu
            </label>
          ...
          <div className={LandingCSS.backgroundImageContainer}>
            <div className={LandingCSS.backgroundImage}>
              ...
              <div className={LandingCSS.backgroundImageOverlay}>
                ...
                <p>
                  An intelligent music learning app based on real-time sound and
                  motion analysis, backed by artificial intelligence technology.
                </p>
                <div
                  id="overlay-signup-button"
                ...
                <div className={LandingCSS.interestLink}>
                  <Link to="https://docs.google.com/forms/d/e/1FAIpQLSdE6QIt2Xfno67jWjBi2SJOB1dImKhmvJYr9Mzi9Qbo1BGHuw/viewform">
                    Stay updated on SkyNote
                  </Link>
                </div>
              </div>
            </div>
      ...
      <div className={LandingCSS.gridContainer}>
        <div className={LandingCSS.gridItem}>
          <div className={LandingCSS.gridTextContainer}>
            ...
            <p>
              With SkyNote, enhance your musical abilities with personalized
              goals and achievements. <br />
              <br />
              Our dynamic system has multiple learning paths that help to
              develop different skills.
              <br />
              <br />
              Using AI-based multimodal analysis, SkyNote gives students live
              feedback on sound quality, intonation, pitch, rhythm, dynamics,
      ...
      <div className={LandingCSS.gridContainer}>
        ...
        <div className={LandingCSS.gridItem}>
          <div className={LandingCSS.gridTextContainer}>
            <h2>For Teachers and Students</h2>
            <p>
              SkyNote empowers students with tools to detect and correct errors,
              building awareness of their technique.
              <br />
              <br />
              Our app aims to eliminate the lack of feedback between lessons and
              independent rehearsal for students, allowing them to practice more
              efficiently alone or in a class setting.
              <br />
              <br />
              SkyNote has been designed with both teachers and students from a
              wide range of levels in mind, from begginers to professional
              players.
              <br />
            </p>
          </div>
      ...
      <div className={LandingCSS.gridContainer}>
        <div className={LandingCSS.gridItem}>
          <div className={LandingCSS.gridTextContainer}>
            <h2>Catalogue</h2>
            <p>
              Enjoy our catalogue of exercises and pieces that focus on specific
              skills and vary in difficulty level.
              <br />
              <br />
              Also available to SkyNote users are recordings from experts
              performing the pieces in our catalogue.
              <br />
              <br />
              If you have a specific piece or exercise you would like to
              practice in SkyNote, you can also import pieces from MusicXML
              files in the app. <br />
            </p>
          </div>
        </div>
