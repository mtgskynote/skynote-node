    ...
    return (
      <div>
        <div className={DemosCSS.siteHeader}>
          <div className={DemosCSS.tabRowContainer}>
            <div className={DemosCSS.tabRow}>
              <div className={DemosCSS.tabLogin}><Link to="/landing" className={DemosCSS.tabLink}> Home </Link></div>
              <div className={DemosCSS.tabLogin}><Link to="/demos" className={DemosCSS.tabLink}> Demos </Link></div>
              <div className={DemosCSS.tabLogin}><Link to="/ourteam" className={DemosCSS.tabLink}> Our Team </Link></div>
              <div className={DemosCSS.tabLogin}><Link to="/research" className={DemosCSS.tabLink}> Research </Link></div>
              <div className={DemosCSS.tabLogin}><Link to="https://docs.google.com/forms/d/e/1FAIpQLSdE6QIt2Xfno67jWjBi2SJOB1dImKhmvJYr9Mzi9Qbo1BGHuw/viewform" className={DemosCSS.tabLink}> Interest Form </Link></div>
              <div className={DemosCSS.tabLogin}><Link to="/register" className={DemosCSS.tabLink}> Login Register </Link></div>
            </div>

            <div className={DemosCSS.dropdown}>
            <input type="checkbox" id="dropdow-toggle" className={DemosCSS.dropdownToggle}></input>
            <label className={DemosCSS.dropbtn} htmlFor="dropdow-toggle">Menu</label>
            <div className={DemosCSS.dropdownContent}>
              <ul>
                <li><Link to="/landing" className={DemosCSS.tabLink}> Home </Link></li>
                <li><Link to="/demos" className={DemosCSS.tabLink}> Demos </Link></li>
                <li><Link to="/ourteam" className={DemosCSS.tabLink}> Our Team </Link></li>
                <li><Link to="/research" className={DemosCSS.tabLink}> Research </Link></li>
                <li><Link to="https://docs.google.com/forms/d/e/1FAIpQLSdE6QIt2Xfno67jWjBi2SJOB1dImKhmvJYr9Mzi9Qbo1BGHuw/viewform" className={DemosCSS.tabLink}> Interest Form </Link></li>
                <li><Link to="/register" className={DemosCSS.tabLink}> Login Register </Link></li>
              </ul>
            </div>
            </div>  
            ...
            <div className={DemosCSS.skynoteContainer}>
              SkyNote
            </div>
        </div>

        <div className={DemosCSS.addspace1}></div> {/* Just horizontal white space  */}
        ...
        <div className={DemosCSS.aboutApp}>
          <div className={DemosCSS.addspace5}></div> {/* Just horizontal white space  */}
