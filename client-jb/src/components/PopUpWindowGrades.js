  ...
  return (
    <div className={PopUpWindowCSS.popUpWindowGrades}>
      <div className={PopUpWindowCSS.contentGrades}>
        ...
        {props.grade ? (
          <div className={PopUpWindowCSS.gradeGrades}>{props.grade}</div>
        ) : (
          <div className={PopUpWindowCSS.gradeGrades}>Not graded</div>
        )}
        {props.comment ? (
          <div className={PopUpWindowCSS.commentGrades}>{props.comment}</div>
        ) : (
          <div className={PopUpWindowCSS.commentGrades}>No comment</div>
        )}
