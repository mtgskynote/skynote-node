    ...
    <div className={PopUpWindowCSS.popUpWindowEdit}>
        <div className={PopUpWindowCSS.contentEdit}>
          ...
          <textarea 
                    ...
                    />
          <button className={PopUpWindowCSS.buttonEdit} onClick={handleUpdate}>Update</button>
          <button className={PopUpWindowCSS.buttonEdit} onClick={handleCancel}>Cancel</button>
        </div>
        {showWarning?<div className={PopUpWindowCSS.warning} >Introduce a valid name or click cancel</div>:""}
    </div>
  );
};
