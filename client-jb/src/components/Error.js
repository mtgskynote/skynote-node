    ...
    if (type === "404") {
        return (
            <div className="flex flex-col items-center justify-center h-screen">
                ...
                <h3 className="text-8xl font-semibold text-gray-900 mb-4 normal-case">Oops!</h3>
                <h3 className="text-xl font-semibold text-gray-600 mb-4 normal-case">Page Not Found</h3>
                <p className="text-lg text-gray-600 mb-8 normal-case">We can't seem to find the page you are looking for.</p>
