      ...
      return (
        <div className="mode-info-message">
          ...
          <div className="mode-description">
            <h5>Practice Mode</h5>
            <p>
              Practice Mode allows you to play as much as you want, but
              recordings won't be saved{' '}
              {/* Describe what Practice Mode consists of */}
            </p>
          </div>
          ...
          <div className="mode-description">
            <h5>Record Mode</h5>
            <p>
              Record Mode lets you record and save data, but you must play the
              whole piece {/* Describe what Record Mode consists of */}
            </p>
          </div>
        </div>
      )
      ...
      return (
        <div className={ModeInfoButtonCSS.container}>
          ...
          <div className={ModeInfoButtonCSS.recBox}>
            <div className={ModeInfoButtonCSS.recTitle}>
              <h5>{props.title}</h5>
            </div>
            <div className={ModeInfoButtonCSS.textGroup}>
              <div>
                <h6>
                  <FontAwesomeIcon
                    icon={faMusic}
                    className={ModeInfoButtonCSS.auxIcon}
                  />
                  {props.score}
                </h6>
              </div>
            ...
            <div className={ModeInfoButtonCSS.starsGroup}>
              <FontAwesomeIcon
                ...
                className={
                  props.stars >= 1
                    ? ModeInfoButtonCSS.completeStar
                    : ModeInfoButtonCSS.incompleteStar
                }
              />
              <FontAwesomeIcon
                icon={faStar}
          ...
          <div className={ModeInfoButtonCSS.message}>
            <h4>Info</h4>
            <p>
              Click "play" to listen to your recording, or iterate through the
