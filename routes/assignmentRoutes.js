...
import { getAllAssignments, putAssignment, deleteAssignment, getLatestAssignment, updateTaskAssignment } from "../controllers/assignmentController.js";
...
assignmentRouter.route("/updateTaskAssignment").put(updateTaskAssignment);
